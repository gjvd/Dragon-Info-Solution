            ...
            <div className="container mx-auto px-6 py-16">
                ...
                <div className="mt-16 text-center bg-white/5 p-12 rounded-2xl border border-white/5">
                    ...
                    <p className="text-gray-400 mb-8 max-w-xl mx-auto">
                        We're always looking for talent. Send your resume to hr.dragoninfo@gmail.com and we'll keep you in mind for future openings.
                    </p>
                    <a href="mailto:hr.dragoninfo@gmail.com" className="inline-block px-8 py-3 rounded-full border border-white/20 hover:bg-white/10 text-white transition-colors">
                        Contact Recruiting
                    </a>
                </div>
            </div>
